...
public class main {
    ...
    private static void divisionAmoeba(int hours, int cellsStart) {
        ...
        for (int i = 3; i < hours + 1; i += 3) {
            cells *= 2;
            System.out.println("Через " + i + " " + getHoursInDeclension(i) + " количество клеток будет: " + cells);
        }
    } //5. Деление клеток

    public static String getHoursInDeclension(int number) {
